...
Version 0.3 · 2026-09-16 · Status: draft
...
- C-2 Language model: Claude. Embeddings: Voyage (hosted, multilingual).
...
| NFR-2 | Average LLM cost per customer question ≤ $0.02. |
| NFR-3 | Ingestion of 500 posts shall complete in ≤ 15 min and cost ≤ $2. |
